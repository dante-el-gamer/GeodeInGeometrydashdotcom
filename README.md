...
![MenuMods](READMEimg/MenuMods.png)
...
| `modSettingsValues["<id>"]` | Valores actuales de settings del mod |
| `window.__modCleanup` | Callback al desactivar el mod |
| `window.__modApplySettings` | Callback al aplicar settings |
...
| | |
|---|---|
| ![PlaceHolder-BlackGreen](READMEimg/PlaceHolder-BlackGreen.png) | ![PlaceHolder-BlackPurple](READMEimg/PlaceHolder-BlackPurple.png) |
| ![PlaceHolder-BlackRed](READMEimg/PlaceHolder-BlackRed.png) | ![PlaceHolder-BlackYellow](READMEimg/PlaceHolder-BlackYellow.png) |
